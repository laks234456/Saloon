...
<body class="bg-slate-50 text-gray-900 antialiased py-12 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <!-- Background Accents -->
    <div class="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-pink-200 rounded-full mix-blend-multiply filter blur-[120px] opacity-60 z-0 pointer-events-none"></div>
    ...
    <div class="relative z-10 w-full max-w-md glass-card rounded-2xl p-8 animate-fade-in-up border-t-4 border-t-purple-500">
        
        <div class="text-center mb-8">
            <div class="mx-auto w-16 h-16 mb-4 rounded-full bg-white border border-purple-200 flex items-center justify-center shadow-lg shadow-purple-200">
                <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
                </svg>
            </div>
            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">Client <span class="text-gradient">Intake</span></h2>
            <p class="mt-2 text-sm text-gray-500">Register a new profile in the directory.</p>
        </div>
        ...
        <form action="customers?action=insert" method="post" class="space-y-6">
            ...
            <div class="pt-6 flex items-center justify-between gap-x-6 border-t border-gray-200 mt-8">
                <a href="index.jsp" class="text-sm font-semibold leading-6 text-gray-500 hover:text-gray-900 transition-colors">Cancel</a>
